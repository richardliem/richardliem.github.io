        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    actionName = userID == 0 ? 
                        "registration is succesfull! <b><a href='Login.aspx'>Click here</a></b> to do login" : 
                        "details updated succesfull! <b><a href='Profile.aspx'>Can check here</a></b>";
                    lblMsg.Visible = true;
