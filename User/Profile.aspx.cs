...
namespace IndoFood.User
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        protected void rPurchaseHistory_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                double grandTotal = 0;
                HiddenField paymentID = e.Item.FindControl("hdhPaymentID") as HiddenField;
        ...
        private sealed class CustomTemplate : ITemplate
        {
            ...
            public void InstantiateIn(Control container)
            {
                ...
                {
                    var footer = new LiteralControl("<tr><td><b>Hungry! Why not order some food for you.</b><a href='Menu.aspx' class='badge badge-info ml-2'>Click to Order</a></td></tr></tbody></table>");
