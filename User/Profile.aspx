<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="IndoFood.User.Profile" %>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-info" id="purchasedHistory-tab" data-toggle="tab" href="#purchasedHistory" 
                                            role="tab" aria-controls="purchasedHistory" aria-selected="false">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="purchasedHistory" role="tabpanel" aria-labelledby="purchasedHistory-tab">
                                        ...
                                        <asp:Repeater ID="rPurchaseHistory" runat="server" OnItemDataBound="rPurchaseHistory_ItemDataBound">
                                            <ItemTemplate>
                                                <div class="container">
                                                    ...
                                                    <asp:HiddenField ID="hdhPaymentID" runat="server" Value='<%# Eval("PaymentID") %>' />
