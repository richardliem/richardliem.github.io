<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="IndoFood.Admin.OrderStatus" %>
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8">
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <asp:Repeater ID="rOderStatus" runat="server" OnItemCommand="rOderStatus_ItemCommand">
                                                        <HeaderTemplate>
